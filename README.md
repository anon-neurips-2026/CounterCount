...
Download the CounterCount dataset from the link provided in the submission and place it under `data/CounterCount/` following the structure described in [`data/README.md`](data/README.md).
